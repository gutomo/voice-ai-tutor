...
├── .dockerignore
├── backend/            # FastAPI。音声: audio.py(ffmpeg)/speech.py(Azure STT+発音)/tts.py(Azure TTS)、採点: parsing.py/scoring.py/combine.py、会話: bedrock.py(Claude)、turns.py(API)、scenarios.py、schemas.py、config.py、tests/
